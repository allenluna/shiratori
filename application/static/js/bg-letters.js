...
// 	let mediaQuery700 = window.matchMedia("(max-width: 765px)")
// 	mediaQuery700.addEventListener("change", () => {
// 		// Check if the media query is true
// 		if (mediaQuery700.matches) {
// 			container.style.width = '765px';
// 			// container.style.backgroundColor = 'red';
// 			container.style.left = "-30%";
// 		}
// 	})

// 	// let mediaQuery425 = window.matchMedia("(max-width: 425px)")
...
// 	let mediaQuery400 = window.matchMedia("(max-width: 320px)")
// 	mediaQuery400.addEventListener("change", () => {
// 		// Check if the media query is true
...
// 	letters_rotate_deg: 180, // (0 = false 360 = 360deg)
// 	letters_rotate_reverse: true, // reverse rotation
// 	letters_color: 'gray', // Color of letters (hex, rgba, name, random)
// 	letters_neon_light: true, // Emission of light from letters.
// 	letters_neon_color: 'gray', // Color of letters (hex, rgba, name, random)
// 	animation_time: 600 // Animation time (s)
// };
